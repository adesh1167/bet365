                ...
                <div className="hrm-0">
                    <div className="hrm-5">
                        ...
                        {user ?
                            <div className="hrm-c hrm-cb">
                                <div className="hrm-2e">
                                    <button className="hrm-d">
                                        ...
                                        <span className="hrm-5c">{lang['offers']}</span>
                                    </button>
                                </div>
                            ...
                            :
                            <div className="hrm-c hrm-f0">
                                <div className="hrm-2e">
                                    <button className="hrm-d">
                                        <span className="hrm-5c">Offers</span>
                                    </button>
                                </div>
                                <button className="hrm-d hrm-9e">
                                    <span className="hrm-5c">{lang["join"]}</span>
                                </button>
                                <button className="hrm-d" onClick={() => setPopup("login")}>
                                    <span className="hrm-5c">{lang["login"]}</span>
                                </button>
                            </div>
                        }
                    </div>
